...
function answer(){
    ...
    if(marks>=28){
        document.querySelector('.condition').innerHTML = "Extremely Severe Depression";
    }
    if(marks>=21 && marks<=27){
        document.querySelector('.condition').innerHTML = "Severe Depression";
    }
    if(marks>=14 && marks<=20){
        document.querySelector('.condition').innerHTML = "Moderate Depression";
    }
    if(marks>=10 && marks<=13){
        document.querySelector('.condition').innerHTML = "Mild Depression";
    }
    if(marks<10){
