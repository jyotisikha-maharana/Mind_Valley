...
function answer(){
    ...
    if(marks>=20){
        document.querySelector('.condition').innerHTML = "Extremely Severe Anxiety";
    }
    if(marks>=15 && marks<=19){
        document.querySelector('.condition').innerHTML = "Severe Anxiety";
    }
    if(marks>=10 && marks<=14){
        document.querySelector('.condition').innerHTML = "Moderate Anxiety";
    }
    if(marks>=8 && marks<=9){
        document.querySelector('.condition').innerHTML = "Mild Anxiety";
    }
    if(marks<8){
